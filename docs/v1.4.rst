...
``class setdoc.core.Basics.Basics(*, excepts: tuple[type[BaseException], ...] = ())``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``__call__(*args: object, **kwargs: object) -> None``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

Try setting ``__doc__`` by ``__name__`` for the ``args``, by keyword for the ``kwargs``.

``class setdoc.core.SetDoc.SetDoc(doc: str | None)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
